...
```{r pollock-socioeco}
pollock_socioeco <- here::here("02_intermediates/ATLANTICPOLLOCK_Commercial_Indicators_Master.csv")
...
```{r pollock-bt-data}
url1 <- here::here("02_intermediates/ATLANTICPOLLOCK_hubert_bottomT.csv")
url2 <- here::here("02_intermediates/ATLANTICPOLLOCK_glorys_bottomT.csv")
```
...
```{r}
sst <- here::here("02_intermediates/ATLANTICPOLLOCK_sst.csv")
```
...
```{r advection}
ecodata::plot_advection(report = "NewEngland", n = 10, varName = 3) +
